...
public class DefaultMetadataStore extends ConfigManager implements MetadataStore {
    ...
    @Override
    public TimerMetadata getTimerMetadata(long timestamp) {
        return null;
    }

    @Override
    public TimerMetadata addTimerMetadata(long timestamp) {
        return null;
    }

    @Override
    public void updateTimerMetadata(TimerMetadata timerMetadata) {

    }

    @Override
    public void iterateTimerMetadata(Consumer<TimerMetadata> callback) {

    }

    @Override
    public void deleteTimerMetadata(long timestamp) {
