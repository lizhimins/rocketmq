...
public class FlatFileStore {
    ...
    public void recoverTieredFlatFile() {
        Semaphore semaphore = new Semaphore((int) (10000 * 0.75));
...
//                }, MessageStoreExecutor.commitExecutor);
    ...
    public ImmutableList<FlatMessageFileExt> deepCopyFlatFileToList() {
...
//        }, 60, 60, TimeUnit.SECONDS);
    ...
    public void doScheduleCleanExpiredTask() {
        ...
        for (FlatMessageFileExt flatFile : deepCopyFlatFileToList()) {
...
//            });
    ...
    public void destroyFile(MessageQueue mq) {
        ...
        FlatMessageFileExt flatFile = flatFileConcurrentMap.remove(mq);
        if (flatFile != null) {
            flatFile.shutdown();
            flatFile.destroy();
        }
