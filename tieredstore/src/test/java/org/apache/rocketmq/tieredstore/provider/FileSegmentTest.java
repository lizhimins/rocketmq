...
public class FileSegmentTest {
    ...
    public void fileAttributesTest() {
        ...
        Assert.assertFalse(fileSegment.isDeleted());
        fileSegment.close();
        Assert.assertTrue(fileSegment.isClosed());
        fileSegment.markDeleted();
        Assert.assertTrue(fileSegment.isDeleted());
    ...
    public void segmentReadTest() throws ClassNotFoundException, NoSuchMethodException {
        ...
        Assert.assertTrue(exception.getCause() instanceof MessageStoreException);
        Assert.assertEquals(MessageStoreErrorCode.ILLEGAL_PARAM, ((MessageStoreException) exception.getCause()).getErrorCode());
