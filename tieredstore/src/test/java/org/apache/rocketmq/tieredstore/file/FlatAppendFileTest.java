...
public class FlatAppendFileTest {
    ...
    public void setUp() throws ClassNotFoundException, NoSuchMethodException {
        ...
        fileQueueFactory = new FlatFileFactory(metadataStore, storeConfig);
    }
...
//
//        FileSegment fileSegment1 = new MemoryFileSegment(
//            FileSegmentType.CONSUME_QUEUE, queue, 100, storeConfig);
//        fileSegment1.initPosition(fileSegment1.getSize() - 100);
//        fileSegment1.setFull();
//        flatCompositeFile.updateFileSegment(fileSegment1);
//        flatCompositeFile.updateFileSegment(fileSegment1);
//
//        FileSegment fileSegment2 = new MemoryFileSegment(
//            FileSegmentType.CONSUME_QUEUE, queue, 1100, storeConfig);
//        fileSegment2.initPosition(fileSegment2.getSize() - 100);
//        flatCompositeFile.updateFileSegment(fileSegment2);
//        flatCompositeFile.updateFileSegment(fileSegment2);
//
//        FlatCompositeFile fileQueue = fileQueueFactory.createFlatFileForConsumeQueue(filePath);
...
//    }
//
//    private FileSegmentMetadata getMetadata(MetadataStore metadataStore, FileSegment fileSegment) {
