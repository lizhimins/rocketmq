...
public class MessageStoreFetcherImplTest {
    ...
    //}
    //
    //public Triple<MessageStoreFetcherImpl, ByteBuffer, ByteBuffer> buildFetcher() throws ClassNotFoundException, NoSuchMethodException {
    //    TieredFlatFileManager flatFileManager = new TieredFlatFileManager(metadataStore, storeConfig);
    //    MessageStoreFetcherImpl fetcher = new MessageStoreFetcherImpl(flatFileManager);
    ...
    //    Triple<MessageStoreFetcherImpl, ByteBuffer, ByteBuffer> triple = buildFetcher();
    //    MessageStoreFetcherImpl fetcher = triple.getLeft();
    ...
    //    MessageStoreFetcherImpl fetcher = new MessageStoreFetcherImpl(storeConfig);
