...
public class TieredFileChunkTest {
    ...
    //    TieredFileChunk container = new TieredFileChunkWithQueue(tieredFileFactory, mq);
    ...
    //        TieredFileSegment.FileSegmentType.COMMIT_LOG, mq, 1000, storeConfig);
    //    segment.initPosition(segment.getSize());
    //
    //    container = new TieredFileChunk(mq, storeConfig);
    ...
    //    TieredFileChunk container = new TieredFileChunk(mq, storeConfig);
